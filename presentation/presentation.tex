...
\usepackage[ngerman]{babel}\documentclass[aspectratio=169,xcolor=dvipsnames]{beamer}
...
\begin{columns}
	...
	\begin{column}{0.5\textwidth}
		\begin{figure}
			\only<4->{\begin{figure}\includegraphics[width=0.75\textwidth]{beta}\caption{Held, Bov\'{e}: Applied Statistical Inference, S. 173}\end{figure}}
		\end{figure}
	\end{column}
\end{columns}
\end{frame}
...
\begin{columns}
	...
	\begin{column}{0.4\textwidth}
		\only<2->{\begin{figure}\includegraphics[width=\textwidth]{baseball}\caption{varianceexplained.org}\end{figure}}
	\end{column}
\end{columns}
\end{frame}
...
\frametitle{Empirische Bayes Methoden}
\begin{itemize}
	\item<1-> Posteriori Trefferverteilung für Spieler A: $\theta\sim Be(82,661\,;\,230,875)$ hat Erwartungswert 0,264
	\item<2-> Posteriori Trefferverteilung für Spieler B: $\theta\sim Be(378,661\,;\,924,875)$ hat Erwartungswert 0,29
\end{itemize}
\end{frame}
